...
public class ProcesoConciliacion {
    ...
    public ProcesoConciliacion(Integer idLogSistema, String mensaje, String idEmpresa, String nombreEps, LocalDate fechaCreacion, LocalDateTime fechaHoraCreacion, Integer idTipoLog, String descripcion) {
